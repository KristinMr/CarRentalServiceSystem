    ...
    public AdminRecycleBinList(Admin admin) {
        ...
        refreshButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Main.main.add(new AdminRecycleBinList(admin));
            }
        });
        ...
        searchButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                StringBuffer stringBuffer = new StringBuffer("select admin.admin_id, admin.admin_name, admin.admin_sex, admin.admin_idn, admin.admin_age, admin.admin_tel, admin.admin_email, admin.admin_address, rank.rank_name, admin.admin_info from admin, rank where admin.admin_rank = rank.rank_id and admin_recycle_bin = 1 ");
