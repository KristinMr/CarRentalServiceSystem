...
public class AdminInfo extends JPanel {
    ...
    public AdminInfo(Admin admin) {
        ...
        adminIDNField.setEditable(false);
        ...
        confirmButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int m = JOptionPane.showConfirmDialog(null, "确认更新个人信息？","更新个人信息", JOptionPane.YES_NO_OPTION);
                if (m == 0) {
                    if (adminTel.trim().equals("")) {
                        JOptionPane.showMessageDialog(null, "管理员联系电话不能为空！请重新输入。");
                    } else {
                        ...
                        try {
                            ...
                            if (n > 0) {
                                ...
                                Main.main.add(new AdminInfo(admin));
                            } else {
